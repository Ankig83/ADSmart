#!/usr/bin/env python3
"""
Download the correct Design hero background from Figma (Графический Дизайн).
Saves to static/assets/images/design-hero-bg.png

Requires: FIGMA_TOKEN in .env
Run: python scripts/download_design_hero_bg.py
"""
import json
import os
...
IMAGE_REF = "dfdd219fbc4241226c63a8e1c5e4ca13569a3dda"
OUT_PATH = BASE_DIR / "static" / "assets" / "images" / "design-hero-bg.png"
